...
/* ─── MATERIALES ─────────────────────────────────── */
const MATS = [
  { nombre:"Paneles CLT Estructurales",     origen:"Austria · Alemania",     desc:"Madera laminada cruzada para estructuras sustentables de alto desempeño. Precisión de ingeniería para edificios en altura y grandes luces.",            tag:"Estructural",  img:"https://picsum.photos/seed/ns-mat-clt/600/400" },
  { nombre:"Fibrocemento Expuesto",          origen:"Japón · Francia",        desc:"Paneles de revestimiento arquitectónico ultra-delgados con textura mineral precisa. Sin mantenimiento, alta durabilidad y estética refinada.",           tag:"Revestimiento", img:"https://picsum.photos/seed/ns-mat-fibro/600/400" },
  { nombre:"Sistemas de Vidrio Estructural", origen:"Alemania · Italia",      desc:"Fachadas acristaladas de piso a techo con rotura de puente térmico y aislación acústica para fachadas premium de uso comercial y residencial.",        tag:"Fachadas",      img:"https://picsum.photos/seed/ns-mat-glass/600/400" },
  { nombre:"Módulos de Tierra Apisonada",    origen:"España · Chile",         desc:"Sistemas prefabricados de tapial. Masa térmica, pigmentación natural y precisión contemporánea en cada panel.",                                          tag:"Envolvente",    img:"https://picsum.photos/seed/ns-mat-earth/600/400" },
